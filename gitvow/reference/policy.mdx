...
| `providers` | Edit/Write paths and route literals in Edit text | each provider asked its declared questions; see [Provider protocol](/gitvow/reference/provider-protocol) | `yes` → confirm with evidence; failure → confirm |
