---
title: "External adapter protocol"
description: "The six built-in adapters are Python inside gitvow"
---
...
| `normalize` | `{"event": "<agent event>", "payload": {...}}` | `{"calls": [{"event": "PreToolUse", "payload": {...}}, ...]}` | translate one agent payload into zero or more gitvow hook calls in the [Claude Code shape](/gitvow/reference/hooks) |
