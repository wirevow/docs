---
title: "The export bundle"
description: "One file per consented data class. A class not consented has no file, and the manifest's consent map says so, so a reviewer learns what travels by listing the directory"
---
...
See also [Session note schema](/gitvow/reference/note) and [Decisions](/gitvow/concepts/decisions).
