---
title: "Hook payloads"
description: "PostToolUse on an editing tool records the blob id of the written file for attribution and takes a working-tree snapshot; on a git commit it writes the session note"
---
...
## Other agents
Codex CLI, Gemini CLI and Cursor are supported through adapters that translate their payloads into this shape; see [Adapter reference](/gitvow/reference/adapters).
