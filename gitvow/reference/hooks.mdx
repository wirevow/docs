---
title: "Hook payloads"
description: "PostToolUse on an editing tool records the blob id of the written file for attribution and takes a working-tree snapshot; on a git commit it writes the session"
---
