---
title: "Let any agent ask the record: the record server"
description: "Hooks reach the agents that run tool calls on this machine. Everything else, a review bot, a planning agent, a"
---
