---
title: "Restore what the agent had"
description: "Your branch and working tree are untouched. Read, run or copy from the worktree, then remove it with git worktree remove . Pass --to  to choose the location"
---
