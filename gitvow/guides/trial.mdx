---
title: "Run a trial and collect results"
description: "A two-week trial with five people answers three questions: how often the gate fires and on what, whether confirmations feel reasonable, and whether anyone reads a note"
---
...
- Whether the redacted ledger should move to a shared place. See [What stays out of git](/gitvow/concepts/storage).
