---
title: "Session notes on pull requests"
description: "GitHub does not display git notes. gitvow puts them where reviewers already look: a comment on the pull request and the check's job summary"
---
