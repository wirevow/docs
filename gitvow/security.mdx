---
title: "Security and the bypass surface"
description: "This page is the honest version. It says where gitvow's enforcement holds, where it does not, and what"
---

you can run yourself to check each statement. Its companion, [What gitvow reads, writes, executes and
sends](/gitvow/trust), states exactly what the tool touches on your machine and in your repository. Every command below was run against 0.15.2 in a throwaway
...
[GitHub Action](/gitvow/guides/pull-requests).
...
See [What stays out of git](/gitvow/concepts/storage).
...
[Redaction and custom rules](/gitvow/guides/redaction).
...
[providers](/gitvow/concepts/providers) and the classifier are how you raise it.
