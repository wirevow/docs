---
title: "The gate"
description: "Before Claude Code runs a tool, it asks gitvow. gitvow answers in one of three ways"
---
...
It inspects tool calls made through Claude Code. A Bash command is inspected as text; a process it spawns is not seen separately. Path checks use the path, not the diff. Regular expressions are a floor; providers and the classifier are how you raise it. See [Write a policy](/gitvow/guides/policy).
