---
title: "Providers: policy from facts"
description: "A regular expression can say 'this path looks like an authorization file'"
---

It cannot say "this route has four callers in two other services" or "this endpoint would be reachable without authentication". Those are facts about the codebase, and they live outside the repository the agent is editing.
