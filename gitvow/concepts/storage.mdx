---
title: "What stays out of git"
description: "The agent's transcript contains tool output: file contents, query results, environment variables, and whatever a database returned"
---
...
Everything that enters a note, the ledger or the log passes through [redaction](/gitvow/guides/redaction), including any rules you add in `redact-rules.json`. It lowers the probability that a secret reaches git. It cannot make it zero, and it does not protect a repository from the people who can already read it.
