...
description: "Paste the output as the first message of the next session, or into the task tracker. It comes entirely from the redacted record, so it is safe to share within the team"
---
