...
description: "Each hit is a session with its date, commit count and the plan it stated. (ledger only) marks a session that ended without committing; its work may survive in snapshots"
---
