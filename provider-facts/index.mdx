---
title: "gitvow-provider-facts"
description: "The gate in gitvow can ask an external program three questions before an agent edits a file: is this file gate-bearing, would this new route be exposed without"
---
...
Static analysis of an estate takes minutes to hours and needs the source of every service. The gate has a fraction of a second and sees one repository. Building the store is a batch job; answering from it is a lookup. The [store](/provider-facts/store) page describes the schema and how to keep it fresh.
